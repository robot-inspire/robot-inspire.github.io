      ...
      <div className={styles.landingTeam}>
        ...
        <div className={styles.landingTeamContainer}>
          ...
          <div className={styles.landingTeamItem}>
            ...
            <p>Laurence has written software in industry roles since 2018, from developing natural language processing tools at Expedia, to building the first prototype of the core API of a pre-seed startup with a seven-figure valuation. Laurence has also developed models for bioinformatics and machine learning research, and has presented his work at ISEF, CWSF and CUCAI. He has been featured on TEDx, is a recipient of the Cansbridge Fellowship, and is currently pursuing his degree in mechanical engineering at McGill University.</p>
